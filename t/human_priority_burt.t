...
my @mixed = (
  { nick => 'Alice', msg => 'burt_bot, help', source_kind => 'conversation' },
  { nick => 'system', msg => 'treb_bot joined' },
  { nick => 'treb_bot', msg => 'burt_bot, question', source_kind => 'bert_conversation' },
  { nick => 'Alice', msg => 'burt_bot, more context', source_kind => 'conversation' },
);
...
my @only_human = (
  { nick => 'Alice', msg => 'burt_bot, first', source_kind => 'conversation' },
  { nick => 'Alice', msg => 'burt_bot, second', source_kind => 'conversation' },
);
